...
<%
    ...
    %>
<input type="hidden" id="parentView" name="parentView" value="student_mgr">
<div id="content">
            <div id="content-header">
                <h1>Student Manager</h1>
            </div>
            <div id="breadcrumb">
                <a href="<%=request.getContextPath()%>/#" title="Go to Home" class="tip-bottom"><i class="glyphicon glyphicon-home"></i> Student Manager</a>
