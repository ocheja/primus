...
<%
    ...
    %>
<input type="hidden" id="parentView" name="parentView" value="lecturer_mgr">
<div id="content">
            <div id="content-header">
                <h1>Lecturer Manager</h1>
            </div>
            <div id="breadcrumb">
                <a href="<%=request.getContextPath()%>/#" title="Go to Home" class="tip-bottom"><i class="glyphicon glyphicon-home"></i> Admin Manager</a>
        ...
        <script src="<%=request.getContextPath()%>/usersarea/js/select2.js"></script>
