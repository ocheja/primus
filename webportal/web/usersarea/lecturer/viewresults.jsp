    ...
    <div class="col-12">
        <div class="widget-box">
            <div class="widget-content nopadding">
                <a class="btn btn-success btn-mini" href="<%= request.getContextPath()%>/view?parent=<%=LecturerState.LecturerParentViews.UPLOAD_RESULTS.name()%>" id="uploadresults" >Upload Result</a>
