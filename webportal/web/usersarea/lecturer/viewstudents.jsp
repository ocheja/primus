    ...
    <div class="col-12">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <a class="btn btn-success btn-mini" href="#myAlert" id="myAlertLink" data-toggle="modal">Download Result Sheet Template</a>
...
<script src="<%=request.getContextPath()%>/usersarea/js/datatable/viewstudentcoursesdata.js"></script>
