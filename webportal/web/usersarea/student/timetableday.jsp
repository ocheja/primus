            ...
            <tr>
                <td class="fc-header-left">
                    <span class="fc-button fc-button-prev fc-state-default fc-corner-left" unselectable="on">
                        <a href="#" onclick="timetableNavigator('previousDay', 'action=timetableevents', 'timetableevents', '/Primus/student/ajax');" ><span class="fc-text-arrow">&lsaquo;</span></a>

                    </span>
                    <span class="fc-button fc-button-next fc-state-default fc-corner-right" unselectable="on">
                        <a href="#" onclick="timetableNavigator('nextDay', 'action=timetableevents', 'timetableevents', '/Primus/student/ajax');" ><span class="fc-text-arrow">&rsaquo;</span></a>
