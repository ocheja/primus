$(document).ready(function() {
    ...
    var oTable = $('#facultyData').dataTable({
        "bProcessing": true,
        "bServerSide": true,
        "bJQueryUI": true,
        "sAjaxSource": "/Primus/admin",
        "fnServerParams": function(aoData) {
            aoData.push({"name": "action", "value": "facultyData"});
        },
        "aoColumns":
                [
                    {"mDataProp": null},
                    {"mDataProp": "facultyName.name"},
                    {"mDataProp": "Description"},
                    {"mDataProp": null,
                        "bSearchable": false,
                        "bSortable": false,
                        "fnRender": function(oObj) {
                            return "<a class='table-action-deletelink btn btn-danger btn-mini' href='/Primus/admin/delete?id=" + oObj.aData.id + "&actionDelete=faculty_delete'>Delete</a>";
                        }
                    }
                ],
...
//            "sDeleteRowButtonId": "deleteAdminBtn",
        ...
        "sUpdateType": "POST",
        oUpdateParameters: {
            "actionPerformed": "facultyDataEdit"
        },
        "oDeleteParameters": {
            "actionDelete": "faculty_delete"
        },
        "aoColumns": [
            null,
            {
